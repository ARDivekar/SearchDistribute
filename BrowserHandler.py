...
try:
	...
	try:
		...
		make_error("BrowserHandler.py", "__main__", "Could not import splinter phantomjs",e)
except Exception, e:
	make_error("BrowserHandler.py", "__main__", "Could not import splinter",e)
